...
<div class="max-w-7xl mx-auto relative min-h-[calc(100vh-8rem)] flex flex-col">
	...
	<div class="bg-white rounded-3xl shadow-xl p-10 border border-gray-100">
		<div class="text-center mb-12">
			...
			<p class="text-gray-600 text-lg">专业的AI驱动翻译处理流程</p>
		</div>
		
		<div class="grid grid-cols-1 md:grid-cols-2 gap-8">
			<div class="group flex items-start space-x-4 p-6 rounded-2xl hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 transition-all duration-300">
				...
				<div class="flex-1">
					<h4 class="font-bold text-gray-900 text-lg mb-2">PDF智能拆分</h4>
					<p class="text-gray-600 leading-relaxed">自动将PDF文档精确拆分为高质量单页图片，保持原始格式与清晰度</p>
				</div>
			</div>
			
			<div class="group flex items-start space-x-4 p-6 rounded-2xl hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-300">
				<div class="flex-shrink-0">
				...
				<div class="flex-1">
					<h4 class="font-bold text-gray-900 text-lg mb-2">OCR智能识别</h4>
					<p class="text-gray-600 leading-relaxed">采用先进OCR技术，高精度识别图片中的文字内容，支持多种语言</p>
				</div>
			</div>
			
			<div class="group flex items-start space-x-4 p-6 rounded-2xl hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-300">
				<div class="flex-shrink-0">
				...
				<div class="flex-1">
					<h4 class="font-bold text-gray-900 text-lg mb-2">民国风格翻译</h4>
					<p class="text-gray-600 leading-relaxed">专业AI翻译引擎，将现代文字转换为典雅的民国时期表达风格</p>
				</div>
			</div>
			
			<div class="group flex items-start space-x-4 p-6 rounded-2xl hover:bg-gradient-to-r hover:from-orange-50 hover:to-amber-50 transition-all duration-300">
				<div class="flex-shrink-0">
				...
				<div class="flex-1">
					<h4 class="font-bold text-gray-900 text-lg mb-2">高效批量处理</h4>
					<p class="text-gray-600 leading-relaxed">支持多用户并发处理，智能任务调度，高效完成大批量翻译工作</p>
				</div>
			</div>
		</div>
